...
const quizQuestions = [
  {
    ...
    ifNotImage: "https://freepngimg.com/thumb/facebook/72547-thinking-photography-question-mark-man-stock.png"
  },
  {
    question: "What is 2 + 2?",
    correctAnswer: "4",
    incorrectAnswers: ["3", "5", "6"],
    image: "https://upload.wikimedia.org/wikipedia/commons/0/02/Telekanal_2%2B2.png",
    ifNotImage: "https://freepngimg.com/thumb/facebook/72547-thinking-photography-question-mark-man-stock.png"
  },
  {
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_bp1jO8qBSTyKTWhHlkWfu9z3PFVup26SGg&s",
    ifNotImage: "https://freepngimg.com/thumb/facebook/72547-thinking-photography-question-mark-man-stock.png"
  },
  {
    ...
    image: "https://science.nasa.gov/wp-content/uploads/2023/07/pia06890-our-solar-system-banner-1920x640-1.jpg?w=1920",
    ifNotImage: "https://freepngimg.com/thumb/facebook/72547-thinking-photography-question-mark-man-stock.png"
  },
  {
    ...
    image: "https://www.shutterstock.com/image-vector/celcius-icon-design-eps-10-600nw-1981593977.jpg",
    ifNotImage: "https://freepngimg.com/thumb/facebook/72547-thinking-photography-question-mark-man-stock.png"
  }
];
  ...
  return (
    <div className="flex flex-col items-center justify-center border-warning border border-opacity-40 h-[85vh] xl:min-w-[500px] shadow-md shadow-warning rounded-lg w-full bg-base-100">
      <div className="w-full p-10 h-full bg-base-300 shadow-md rounded-lg flex flex-col justify-between">
        ...
        <div className="min-h-[55%] overflow-y-scroll mb-4 border border-warning flex items-center justify-center border-opacity-25 rounded-md p-2">
          {!quizCompleted ? (
            <>
              <div className="flex justify-center mb-4">
                <img
                  src={quizQuestions[currentQuestionIndex]?.image || quizQuestions[currentQuestionIndex]?.ifNotImage}
                  alt="quiz question"
                  className="max-h-40"
                />
              </div>
